...
namespace WindowsFormsApplication3
{
    class LuceneClass
    {
        ...
        public string[,] SearchTxT(string txt,int type)
        {
            ...
            //str[0,0] = "Searching For " + query.ToString() + "\n";
            ...
            foreach (var hit in hits)
            {
                ...
                str[i,1] = documentFromSearch.Get(typetxt);
                i++;
            }
        ...
        public string[,] SearchId(string id,int type)
        {
            ...
            foreach (var hit in hits)
            {
                ...
                var documentFromSearch = indexSearch.Doc(hit.Doc);
                str[0,1] = "가수 : " + documentFromSearch.Get("가수");
                str[0,2] = "제목 : " + documentFromSearch.Get("제목");
                str[0,3] = "가사 : " + documentFromSearch.Get("가사");
                i++;
            }
